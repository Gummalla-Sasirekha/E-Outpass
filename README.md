...
``` bash
git clone https://github.com/Gummalla-Sasirekha/E-Outpass.git
cd E-Outpass
```
...
For testing on a phone connected to the same local network, the frontend
can be accessed through the computer's LAN address.
